...
/**
    Parse beginning of string from a longer string. If successful return the number of chars
    consumed while parsing. Value vptr will containg string if successful
    @param v Pointer to a value struct instance
    @param str string that will get parsed to get other string
    @return int of number of chars read in
*/
